...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center relative" style={{ backgroundImage: 'url("https://png.pngtree.com/thumb_back/fh260/back_our/20190628/ourmid/pngtree-banner-technology-gradient-geometric-stereo-background-image_277350.jpg")' }}>
      <div className="absolute inset-0 bg-black opacity-60"></div>
      <motion.div
        className="relative bg-white bg-opacity-20 backdrop-blur-lg p-8 rounded-lg shadow-2xl max-w-md w-full border border-gray-300"
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="relative">
            ...
            <input
              className="w-full px-10 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-transparent text-white placeholder-gray-300"
              {...register('username')}
              placeholder="Email"
            />
          </div>
          <div className="relative">
            <FiLock className="absolute left-3 top-3 text-white" />
            <input
              className="w-full px-10 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-transparent text-white placeholder-gray-300"
              type="password"
              {...register('password')}
